...
(:
 ...
 The source model was Race-0.0.1
 ...
 Generated at timestamp: 2022-09-19T15:35:34.176515Z
 :)
...
) as map:map
{
    ...
    let $name  :=             $source-node/name[not(. instance of null-node())] ! xs:string(.)
    (: The following property is a local reference.  :)
    let $comprisedOfRuns  :=                es:extract-array($source-node/comprisedOfRuns, race:extract-instance-Run#1)
    (: The following property is a local reference.  :)
    let $wonByRunner  :=             $source-node/wonByRunner[not(. instance of null-node())] ! race:extract-instance-Runner(.)
    let $courseLength  :=             $source-node/courseLength[not(. instance of null-node())] ! xs:decimal(.) 
    ...
    then $instance
        ...
        =>es:optional('wonByRunner', $wonByRunner)
...
) as map:map
{
    ...
    let $id  :=             $source-node/id[not(. instance of null-node())] ! xs:string(.)
    let $date  :=             $source-node/date[not(. instance of null-node())] ! xs:date(.)
    let $distance  :=             $source-node/distance[not(. instance of null-node())] ! xs:decimal(.)
    let $distanceLabel  :=              $source-node/distanceLabel[not(. instance of null-node())] ! xs:string(.)
    let $duration  :=             $source-node/duration[not(. instance of null-node())] ! xs:dayTimeDuration(.)
    (: The following property is a local reference.  :)
    let $runByRunner  :=             $source-node/runByRunner[not(. instance of null-node())] ! race:extract-instance-Runner(.) 
...
) as map:map
{
    ...
    let $name  :=             $source-node/name[not(. instance of null-node())] ! xs:string(.)
    let $age  :=             $source-node/age[not(. instance of null-node())] ! xs:int(.)
    let $gender  :=             $source-node/gender[not(. instance of null-node())] ! xs:string(.) 
